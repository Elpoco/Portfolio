const portfolioData = {
  ...
  projects: [
    ...
    },
    {
      ...
      details: [
        "OpenCV 이미지 필터링(그레이스케일, 가우시안 블러, 이진화)을 거친 최적 윤곽선 추출 스캐너 모듈 구현",
        "Google Cloud Vision API (OCR)를 활용한 차대번호의 텍스트 인식 정밀 파싱 로직 개발",
        "ZXing 오픈소스를 활용한 1D/2D 바코드 고속 스캔 및 결과 연동"
      ],
      achievements: [
    ...
    },
    {
      ...
      banner: "assets/images/logo_ezpen.png",
      platforms: ["Web"],
      description: "여행 매칭 플랫폼 'Only1Trip'의 어드민 콘솔입니다.",
      details: [
      ...
      achievements: [
        { title: "Unified moderating", desc: "커뮤니티 글 검열 및 여행 상품 매니지먼트의 완전 단일화" },
